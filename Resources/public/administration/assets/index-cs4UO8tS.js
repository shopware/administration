const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-9ZiJML_W.js","assets/index-BzoS81zQ.css","assets/index-ByR_ocpn.js","assets/index-k7L4EYIY.css","assets/index-06QqMN9n.js","assets/index-BXhO5yov.css","assets/index-BnhJ-gZz.js","assets/index-BZiSbt2C.css","assets/index-DGYDe0MQ.js","assets/index-CE5BPrir.css","assets/index-H5kZAkxJ.js","assets/index-CNPknCzY.css","assets/index-BF7C33Ge.js","assets/index-CMLHi9Fr.css","assets/index-2fcSxVru.js","assets/index-D5hm6lWg.css","assets/index-BBunFsQ1.js","assets/index-ZLS2Frkj.css","assets/index-k3B2PzaL.js","assets/index-BnVLdLFY.css","assets/index-71nZjCBq.js","assets/index-Ccm3Uu34.css","assets/index-dgsDykJe.js","assets/index-COJv9EoM.css","assets/index-DLlIMH0i.js","assets/index-CjDCx6Mz.css","assets/index-BOuHbig7.js","assets/index-BiofiMIA.css","assets/index-D6qKMiJu.js","assets/index-BmCMNmwN.css","assets/index-Cibn6jdN.js","assets/index-CdBEJD3t.css","assets/index-D-TMMNFe.js","assets/index-BWqjrdfF.css","assets/index-Bf9p-_YB.js","assets/index-Bu6DFLpA.css","assets/index-CgJgi2G-.js","assets/index-DL4gaSPk.css"])))=>i.map(i=>d[i]);
var u=Object.defineProperty;var m=(t,r,e)=>r in t?u(t,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[r]=e;var d=(t,r,e)=>m(t,typeof r!="symbol"?r+"":r,e);import{R as g,_ as n}from"./administration-C5SrSbyi.js";import{U as f}from"./user-config.class-fFOxsubu.js";import{s as _}from"./main-BOBrVyAu.js";const{Application:h}=Shopware;h.addServiceProvider("exportTemplateService",()=>({registerProductExportTemplate:v,getProductExportTemplateByName:y,getProductExportTemplateRegistry:P}));const c={};function v(t){return c[t.name]=t,!0}function y(t){return c[t]}function P(){return c}const w=`aid,{#- -#}
brand,{#- -#}
mpnr,{#- -#}
ean,{#- -#}
name,{#- -#}
...
{%- if product.media|length > 1 -%}
    ...
    {%- endfor -%}"
{%- endif -%}{#- -#}
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"billiger_de",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.billiger-de",headerTemplate:w.trim(),bodyTemplate:C.trim(),footerTemplate:"",fileName:"billiger.csv",encoding:"UTF-8",fileFormat:"csv",generateByCronjob:!1,interval:86400});const I=`"categoryPath",{#- -#}
"brand",{#- -#}
"title",{#- -#}
"price",{#- -#}
"basePrice",{#- -#}
...
`,N=`"{%- if product.categories.count > 0 -%}
    {{ product.categories.first.getBreadCrumb|slice(1)|join(' > ')|raw }}{#- -#}
{%- endif -%}",{#- -#}
"{{ product.manufacturer.translated.name ?? '' }}",{#- -#}
...
"0.00",{#- Change or add your payment methods -#}
"0.00"{#- Change or add your payment methods -#}
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"idealo",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.idealo",headerTemplate:I.trim(),bodyTemplate:N.trim(),footerTemplate:"",fileName:"idealo.csv",encoding:"UTF-8",fileFormat:"csv",generateByCronjob:!1,interval:86400});const b=`<?xml version="1.0" encoding="UTF-8" ?>
...
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"google-product-search-de",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.google-product-search-de",headerTemplate:b.trim(),bodyTemplate:E,footerTemplate:O.trim(),fileName:"google.xml",encoding:"UTF-8",fileFormat:"xml",generateByCronjob:!1,interval:86400});const V=`{% set title = product.translated.name|default(product.name)|default('')|trim %}
...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
        ...
        <link>{{ productExport.salesChannelDomain.url }}</link>
        <language>{{ productExport.salesChannelDomain.language.locale.code }}</language>`,T=`{%- set title = product.translated.name|default(product.name)|default('')|trim -%}
{%- set description = product.translated.description|default(title)|default('')|striptags|trim -%}
{%- set price = product.calculatedPrice -%}
{%- if product.calculatedPrices.count > 0 -%}
    {%- set price = product.calculatedPrices.last -%}
