const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C9LkuUVa.js","assets/index-BzoS81zQ.css","assets/index-ByR_ocpn.js","assets/index-k7L4EYIY.css","assets/index-D6lUT3iJ.js","assets/index-g9VAP1fb.css","assets/index-CaGybO-l.js","assets/index-CZmJ6t3I.css","assets/index-DFGTRt5X.js","assets/index-E-0dQQH8.css","assets/index-BeqiJlLx.js","assets/main-wTwLEbzK.js","assets/administration-BuakZwUh.js","assets/administration-D0_l-nuf.css","assets/main-CRhxNdvE.css","assets/index-BjsqvC72.css","assets/index-H5kZAkxJ.js","assets/index-CNPknCzY.css","assets/index-BKXlU1ZW.js","assets/index-CeRJ247S.css","assets/index-2fcSxVru.js","assets/index-D5hm6lWg.css","assets/index-_IhKYoHo.js","assets/index-BAMKfCgE.css","assets/index-BTb5zJ8e.js","assets/index-DgkRWnkH.css","assets/index-Df7JzoD7.js","assets/index-CGVd0fri.css","assets/index-k3B2PzaL.js","assets/index-BnVLdLFY.css","assets/index-71nZjCBq.js","assets/index-Ccm3Uu34.css","assets/index-dgsDykJe.js","assets/index-COJv9EoM.css","assets/index-DLlIMH0i.js","assets/index-CjDCx6Mz.css","assets/index-BOuHbig7.js","assets/index-BiofiMIA.css","assets/index-D6qKMiJu.js","assets/index-BmCMNmwN.css","assets/index-Cibn6jdN.js","assets/index-CdBEJD3t.css","assets/index-DjsIOZ5b.js","assets/index-CK6nHLZA.css","assets/index-DNfXFOQg.js","assets/index-DSdORlzp.css","assets/index-CgJgi2G-.js","assets/index-DL4gaSPk.css"])))=>i.map(i=>d[i]);
var g=Object.defineProperty;var f=(i,t,e)=>t in i?g(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var d=(i,t,e)=>f(i,typeof t!="symbol"?t+"":t,e);import{R as h,_ as n}from"./administration-BuakZwUh.js";import{U as _}from"./user-config.class-fFOxsubu.js";import{s as v}from"./main-wTwLEbzK.js";const{Application:y}=Shopware;y.addServiceProvider("exportTemplateService",()=>({registerProductExportTemplate:w,getProductExportTemplateByName:P,getProductExportTemplateRegistry:C}));const l={};function w(i){return l[i.name]=i,!0}function P(i){return l[i]}function C(){return l}const I=`aid,{#- -#}
brand,{#- -#}
mpnr,{#- -#}
ean,{#- -#}
name,{#- -#}
...
`,E=`"{%- if product.categories.count > 0 -%}
    {{ product.categories.first.getBreadCrumb|slice(1)|join(' > ')|raw }}{#- -#}
{%- endif -%}",{#- -#}
"{{ product.manufacturer.translated.name ?? '' }}",{#- -#}
...
"0.00",{#- Change or add your payment methods -#}
"0.00"{#- Change or add your payment methods -#}
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"idealo",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.idealo",headerTemplate:b.trim(),bodyTemplate:E.trim(),footerTemplate:"",fileName:"idealo.csv",encoding:"UTF-8",fileFormat:"csv",generateByCronjob:!1,interval:86400});const S=`<?xml version="1.0" encoding="UTF-8" ?>
...
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"google-product-search-de",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.google-product-search-de",headerTemplate:S.trim(),bodyTemplate:O,footerTemplate:V.trim(),fileName:"google.xml",encoding:"UTF-8",fileFormat:"xml",generateByCronjob:!1,interval:86400});const T=`{% set title = product.translated.name|default(product.name)|default('')|trim %}
