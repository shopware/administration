const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CQOgeMh9.js","assets/index-LAf-pYmf.css","assets/index-oPRxrwKx.js","assets/index-k7L4EYIY.css","assets/index-D6lUT3iJ.js","assets/index-g9VAP1fb.css","assets/index-CaGybO-l.js","assets/index-CZmJ6t3I.css","assets/index-CgzI1OMe.js","assets/index-E-0dQQH8.css","assets/index-vdh8iL4x.js","assets/main-ZuCuRVFv.js","assets/administration-CxpVl_zk.js","assets/main-pNUkwLsE.css","assets/index-BjsqvC72.css","assets/index-4hQDgcXW.js","assets/index-veVC6IQH.css","assets/index-w5L9TbXz.js","assets/index-CeRJ247S.css","assets/index-BAbONpjj.js","assets/index-D5hm6lWg.css","assets/index-B1kfMH5b.js","assets/index-BAMKfCgE.css","assets/index-RCJvbAN3.js","assets/index-DgkRWnkH.css","assets/index-Df7JzoD7.js","assets/index-CGVd0fri.css","assets/index-CXWvJkhl.js","assets/index-BnVLdLFY.css","assets/index-71nZjCBq.js","assets/index-Ccm3Uu34.css","assets/index-dgsDykJe.js","assets/index-COJv9EoM.css","assets/index-DLlIMH0i.js","assets/index-CjDCx6Mz.css","assets/index-DktxtDZX.js","assets/index-DeVP5Kwb.css","assets/index-BQZEWukC.js","assets/index-BmCMNmwN.css","assets/index-B2ie-M6N.js","assets/index-CdBEJD3t.css","assets/index-yHD53E36.js","assets/index-CK6nHLZA.css","assets/index-B1s3eg7x.js","assets/index-CQQ_pyIR.css","assets/index-CgJgi2G-.js","assets/index-DL4gaSPk.css"])))=>i.map(i=>d[i]);
var f=Object.defineProperty;var h=(i,t,e)=>t in i?f(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var d=(i,t,e)=>h(i,typeof t!="symbol"?t+"":t,e);import{Y as _,_ as n}from"./administration-CxpVl_zk.js";import{U as v}from"./user-config.class-DDsspS3_.js";import{s as y}from"./main-ZuCuRVFv.js";const{Application:w}=Shopware;w.addServiceProvider("exportTemplateService",()=>({registerProductExportTemplate:P,getProductExportTemplateByName:C,getProductExportTemplateRegistry:I}));const l={};function P(i){return l[i.name]=i,!0}function C(i){return l[i]}function I(){return l}const N=`aid,{#- -#}
brand,{#- -#}
mpnr,{#- -#}
ean,{#- -#}
name,{#- -#}
...
{%- if product.media|length > 1 -%}
    ...
    {%- endfor -%}"
{%- endif -%}{#- -#}
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"billiger_de",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.billiger-de",headerTemplate:N.trim(),bodyTemplate:b.trim(),footerTemplate:"",fileName:"billiger.csv",encoding:"UTF-8",fileFormat:"csv",generateByCronjob:!1,interval:86400});const S=`"categoryPath",{#- -#}
"brand",{#- -#}
"title",{#- -#}
"price",{#- -#}
"basePrice",{#- -#}
...
`,E=`"{%- set productTypeCategory = product.seoCategory ?? product.categories.first -%}
{%- if productTypeCategory -%}
    {{ productTypeCategory.breadCrumb|slice(1)|join(' > ')|raw }}{#- -#}
{%- endif -%}",{#- -#}
"{{ product.manufacturer.translated.name ?? '' }}",{#- -#}
...
"0.00",{#- Change or add your payment methods -#}
"0.00"{#- Change or add your payment methods -#}
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"idealo",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.idealo",headerTemplate:S.trim(),bodyTemplate:E.trim(),footerTemplate:"",fileName:"idealo.csv",encoding:"UTF-8",fileFormat:"csv",generateByCronjob:!1,interval:86400});const O=`<?xml version="1.0" encoding="UTF-8" ?>
...
`;Shopware.Service("exportTemplateService").registerProductExportTemplate({name:"google-product-search-de",translationKey:"sw-sales-channel.detail.productComparison.templates.template-label.google-product-search-de",headerTemplate:O.trim(),bodyTemplate:T,footerTemplate:V.trim(),fileName:"google.xml",encoding:"UTF-8",fileFormat:"xml",generateByCronjob:!1,interval:86400});const x=`{% set title = product.translated.name|default(product.name)|default('')|trim %}
...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0" xmlns:atom="http://www.w3.org/2005/Atom">
    <channel>
        ...
        <link>{{ productExport.salesChannelDomain.url }}</link>
        <language>{{ productExport.salesChannelDomain.language.locale.code }}</language>`,U=`{%- set title = product.translated.name|default(product.name)|default('')|trim -%}
{%- set description = product.translated.description|default(title)|default('')|striptags|trim -%}
{%- set price = product.calculatedPrice -%}
{%- if product.calculatedPrices.count > 0 -%}
    {%- set price = product.calculatedPrices.last -%}
