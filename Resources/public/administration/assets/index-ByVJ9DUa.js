...
var u=Object.defineProperty;var m=(t,r,e)=>r in t?u(t,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[r]=e;var s=(t,r,e)=>m(t,typeof r!="symbol"?r+"":r,e);import{R as g,_ as n}from"./administration-C2BiybL2.js";import{U as f}from"./user-config.class-fFOxsubu.js";import{s as _}from"./main-Db-S_vUw.js";const{Application:h}=Shopware;h.addServiceProvider("exportTemplateService",()=>({registerProductExportTemplate:v,getProductExportTemplateByName:y,getProductExportTemplateRegistry:w}));const p={};function v(t){return p[t.name]=t,!0}function y(t){return p[t]}function w(){return p}const P=`aid,{#- -#}
brand,{#- -#}
mpnr,{#- -#}
ean,{#- -#}
name,{#- -#}
