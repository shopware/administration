...
var u=Object.defineProperty;var m=(n,r,e)=>r in n?u(n,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[r]=e;var o=(n,r,e)=>m(n,typeof r!="symbol"?r+"":r,e);import{N as h,_ as t}from"./administration-amUAJIlj.js";import{U as _}from"./user-config.class-fFOxsubu.js";import{s as g}from"./main-BI6qVbzW.js";const{Application:v}=Shopware;v.addServiceProvider("exportTemplateService",()=>({registerProductExportTemplate:f,getProductExportTemplateByName:y,getProductExportTemplateRegistry:w}));const d={};function f(n){return d[n.name]=n,!0}function y(n){return d[n]}function w(){return d}const C=`aid,{#- -#}
brand,{#- -#}
mpnr,{#- -#}
ean,{#- -#}
name,{#- -#}
